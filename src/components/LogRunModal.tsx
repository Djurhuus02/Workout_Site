...
export default function LogRunModal({ onSave, onClose }: Props) {
  ...
  const canSave = distanceKm > 0 && durationSeconds > 0
    ...
    >
      ...
      >
        ...
        <div style={{ marginBottom: 16 }}>
          <p style={labelStyle}>Distance (km)</p>
          <input
            type="number" inputMode="decimal" min={0} step={0.01}
            value={distance} onChange={e => setDistance(e.target.value)}
            placeholder="5.0" autoFocus style={inputStyle}
          />
        </div>
